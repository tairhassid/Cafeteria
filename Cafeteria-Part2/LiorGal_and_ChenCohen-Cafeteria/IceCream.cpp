...
const char* flavors[] = { "Chocolate", "Vanilla", "Cherry", "Banana" };

IceCream::IceCream(eFlavor flavor, int numOfScoops) : Item(PRICE_PER_SCOOP*numOfScoops), flavor(flavor), numOfScoops(numOfScoops) {}
